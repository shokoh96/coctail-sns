...
<div class="form-content">
    <div class="form-content-top d-flex">
        ...
        <div class="form-tp-right">
            <div class="form-group row">
                <label for="name" class="col-2 col-form-label">名前<small class="ml-1">(必須)</small></label>
                <div class="col-10">
            ...
            <div class="form-group row">
                <label for="base" class="col-2 col-form-label">ベース<small class="ml-1">(任意)</small></label>
                <div class="col-10">
            ...
            <div class="form-group row">
                <label for="taste" class="col-2 col-form-label">味<small class="ml-1">(任意)</small></label>
                <div class="col-10">
            ...
            <div class="form-group row">
                <label for="feature" class="col-2 col-form-label">特徴<small class="ml-1">(任意)</small></label>
                <div class="col-10">
    ...
    <div class="form-group row mt-4">
        <label for="material" class="col-12 col-form-label">作り方(300文字以内)<small
                class="ml-1">(任意)</small></label>
        <div class="col-sm-12">
    ...
    <div class="form-group row">
        <label for="comment" class="col-12 col-form-label">コメント(500文字以内)<small
                class="ml-1">(任意)</small></label>
        <div class="col-sm-12">
